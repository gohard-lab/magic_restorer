...
class MagicRestorer:
    def __init__(self, root):
        ...
        log_app_usage("magic_restore_lite", "app_opened")
    ...
    def load_image(self):
        ...
        log_app_usage("magic_restore_lite", "image_loaded")
    ...
    def set_clone_source(self, event):
        ...
        # log_app_usage("magic_restore_lite", "clone_source_set")
    ...
    def undo(self, event=None):
        ...
        # log_app_usage("magic_restore_lite", "undo_used")
    ...
    def toggle_mode(self, event=None):
        ...
        # log_app_usage("magic_restore_lite", "mode_changed", details={"selected_mode": self.mode_name})
    ...
    def reset_image(self, event=None):
        ...
        if messagebox.askyesno("초기화", "모든 작업을 취소하고 처음으로 돌아갈까요?"):
            # log_app_usage("magic_restore_lite", "image_reset")
            self.load_image() 
    ...
    def zoom_in(self, event=None):
        ...
        self.zoom_scale += 0.2
        self.refresh_canvas()
        # log_app_usage("magic_restore_lite", "zoomed_in", details={"scale": self.zoom_scale})
        return "break"
    ...
    def zoom_out(self, event=None):
        ...
        if self.zoom_scale > 0.4:
            self.zoom_scale -= 0.2
            self.refresh_canvas()
            # log_app_usage("magic_restore_lite", "zoomed_out", details={"scale": self.zoom_scale})
    ...
    def increase_brush(self, event=None):
        ...
        self.update_title()
        self.refresh_canvas() 
        # log_app_usage("magic_restore_lite", "brush_increased", details={"size": self.brush_size})
        return "break"
    ...
    def decrease_brush(self, event=None):
        ...
        self.update_title()
        self.refresh_canvas()
        # log_app_usage("magic_restore_lite", "brush_decreased", details={"size": self.brush_size})
        return "break"
    ...
    def save_image(self, event=None):
        ...
        if path:
            ...
            log_app_usage("magic_restore_lite", "image_saved")
